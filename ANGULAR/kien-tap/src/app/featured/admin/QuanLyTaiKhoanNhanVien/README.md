...
Mở VS Code tại thư mục project: `D:\kien-tap-code\ANGULAR\kien-tap`
...
---
> [!IMPORTANT]
> **Lưu ý:** Tuyệt đối không `merge` code vào `main` nếu chưa được sự đồng ý của leader hoặc chưa qua kiểm tra!
