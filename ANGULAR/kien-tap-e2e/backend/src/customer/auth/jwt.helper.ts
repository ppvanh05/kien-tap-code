...
const JWT_SECRET = process.env.JWT_SECRET || 'default-secret-key-for-customer-portal-2026';
...
export class JwtHelper {
  ...
  static sign(payload: Omit<JwtPayload, 'exp'>, expiresInSeconds: number = 86400): string {
